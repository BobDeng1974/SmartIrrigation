...
Status GPDMA_Setup(GPDMA_Channel_CFG_Type *GPDMAChannelConfig, fnGPDMACbs_Type *pfnGPDMACbs)
{
    ...
    DMA_Change_Channel_Configuration(GPDMAChannelConfig);
...
void DMA_Change_Channel_Configuration(GPDMA_Channel_CFG_Type *GPDMAChannelConfig)
{
    LPC_GPDMACH_TypeDef *pDMAch;
...
unsigned int Get_DMA_channel_Count(unsigned int Channel_No)
{
    LPC_GPDMACH_TypeDef *pDMAch;

	pDMAch = (LPC_GPDMACH_TypeDef *) pGPDMACh[Channel_No];
	return (pDMAch->DMACCControl & 0x00000FFF);
}
